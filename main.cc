...
/***************************************************************
 * @file       Hybrid Astar Parking
 * @brief      Parking
 * @author     Forvision ENG-SW-T3-Jiatan(Organize and modify)
 * @version    1.0
 * @date       20230818
 **************************************************************/
...
//*****************************************************************************
  ...
  PlotObstacles_Init(parking_scenario.obstacles);
  ...
  printHybridAStarResult(result, file_name);                                
  PlotObstacles(parking_scenario.obstacles);
  PlotVehicleTraj(vehicle_param, result.x, result.y, result.phi,parking_scenario.obstacles,parking_scenario.boundary);                  
  plt::show();              
  return 0;
}
